...
define([], function () {
  ...
  function ViewIDInfoController($q, $scope, $rootScope, $stateParams, $state, $modal, $aside, $modalInstance, Identify3D, orderData, confirmationDialogService){
  ...
  return {'ViewIDInfoController': ['$q','$scope', '$rootScope', '$stateParams', '$state', '$modal', '$aside', '$modalInstance', 'Identify3DObject', 'orderData', 'confirmationDialogService', ViewIDInfoController]};
});
